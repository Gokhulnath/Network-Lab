...
set outfile [open  "congestion1.in"  w]
$ns  at  0.0  "plotWindow $tcp1  $outfile"

set outfile [open  "congestion0.in"  w]
...
proc finish {} {
	...
	puts "running nam..."
	exec nam out.nam &
	exec xgraph congestion1.in -geometry 300x300 &
	exec xgraph congestion0.in -geometry 300x300 &
	exit 0
}
